  ...
  return (
    <section id="about" className="relative w-full bg-black overflow-hidden flex flex-col items-center py-24">
      ...
      <div className="w-full max-w-[1400px] relative px-8 flex flex-col">
        ...
        {/* Main Editorial Grid */}
        <div className="grid grid-cols-[1fr_1.5fr_1fr] gap-12 items-center mb-20 relative">
          
          {/* COLUMN 1: LEFT TITLES */}
          <div className="flex flex-col items-start relative z-20">
            <div className="relative mb-6">
              <span className="absolute -left-4 top-2 text-[#FF2200] text-[10px]">●</span>
              <h2 className="text-[2.5rem] font-light tracking-tight text-white/80 leading-none uppercase">
                WHO IS<br />
                THE —
              </h2>
            </div>
            
            <p className="text-[0.75rem] tracking-[0.2em] text-white/40 uppercase mb-8">
          ...
          <div className="relative flex justify-center items-center">
             ...
             <motion.h3 
               ...
               className="absolute left-[-20%] top-[40%] text-[8rem] font-[900] tracking-[-0.05em] text-white z-30 uppercase pointer-events-none"
             ...
             {/* IMAGE CONTAINER */}
             <div className="relative bg-white p-[10px] aspect-[3/4] w-full max-w-[380px] shadow-2xl z-10">
                ...
                <div className="absolute bottom-4 left-4 text-[9px] font-bold tracking-widest uppercase text-black/40">
                  EP \\ 2025
                </div>
             </div>
          </div>
          ...
          <div className="flex flex-col items-end text-right z-20">
            <motion.p 
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.2 }}
              className="text-[0.85rem] font-normal tracking-[0.05em] leading-[1.6] text-white/70 uppercase"
            >
            ...
            <div className="my-8 text-white/20 text-lg font-light">\\</div>

            <motion.p 
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.4 }}
              className="text-[0.85rem] font-normal tracking-[0.05em] leading-[1.6] text-white/60 uppercase"
            >
        ...
        <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] mt-12">
          ...
          <div className="relative overflow-hidden whitespace-nowrap py-4 border-y border-white/10 bg-white/5">
            <motion.div 
